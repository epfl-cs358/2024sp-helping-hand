...
\begin{minipage}[t]{0.30\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{
    \includegraphics[width=\textwidth]{latex-img/shema_top.png}}
\end{minipage}\hfill
\begin{minipage}[t]{0.65\textwidth}
...
\begin{minipage}[t]{0.45\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{
    \includegraphics[width=\textwidth]{latex-img/shema_front.png}}
\end{minipage}\hfill


\begin{minipage}[t]{0.30\textwidth}
    \centering\raisebox{\dimexpr \topskip-\height}{
    \includegraphics[width=\textwidth]{latex-img/shema_solenoid_holder.png}}
\end{minipage}\hfill
\begin{minipage}[t]{0.65\textwidth}
    \vspace{5mm}
